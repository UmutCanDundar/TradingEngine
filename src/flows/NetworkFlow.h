...
//
// PURPOSE:
// - Lifecycle controller for the Network stage execution.
// - Responsible for binding a single Network component to a dedicated thread.
...
public:
    ...
    NetworkFlow(NetworkFlow &&) = delete;
    NetworkFlow &operator=(NetworkFlow &&) = delete;
