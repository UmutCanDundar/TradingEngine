...
Parser_FIX::Parser_FIX(SessionManager &sess_mngr, spscFIXInSessionQueue_t &parser_to_fixbuilder_in) noexcept : sess_mngr_(sess_mngr), parser_to_fixbuilder_in_(parser_to_fixbuilder_in)
{
