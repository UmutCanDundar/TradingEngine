...
//
// PURPOSE:
// - High-performance, allocation-free parser for BIST OUCH messages.
...
//    * Raw object size is ~210 KB, however allocation decisions for this class are NOT based on size.
...
private:
    ...
    MessagePools<BIST::OUCHMessageTypes> ouch_pools_;

    using MessageHandlerFunc = void (*)(Parser_OUCH_BIST&, const char *, BIST::OUCHMessage &) noexcept;
