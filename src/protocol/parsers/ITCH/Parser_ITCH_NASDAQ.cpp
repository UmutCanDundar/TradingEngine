...
const std::array<Parser_ITCH_NASDAQ::MessageHandlerFunc, Parser_ITCH_NASDAQ::MAX_MESSAGES> Parser_ITCH_NASDAQ::makeMessageHandlersLookup() noexcept
{
   ...
   handlers[0] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHAddOrderMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHAddOrderMessage>().acquire(m);

      m->timestamp = Endian::read_u48_be(data + 5);
   ...
   handlers[1] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHAddOrderMPIDMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHAddOrderMPIDMessage>().acquire(m);
   ...
   handlers[2] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHCancelMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHCancelMessage>().acquire(m);
   ...
   handlers[3] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHExecutedMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHExecutedMessage>().acquire(m);
   ...
   handlers[4] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHExecutedWithPriceMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHExecutedWithPriceMessage>().acquire(m);
   ...
   handlers[5] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHDeleteMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHDeleteMessage>().acquire(m);
   ...
   handlers[6] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHReplaceMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHReplaceMessage>().acquire(m);
   ...
   handlers[7] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHTradeMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHTradeMessage>().acquire(m);
   ...
   handlers[8] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHSystemEventMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHSystemEventMessage>().acquire(m);
   ...
   handlers[9] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHStockDirectoryMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHStockDirectoryMessage>().acquire(m);
   ...
   handlers[10] = [](Parser_ITCH_NASDAQ &parser, const char *data, NASDAQ::ITCHMessage &msg) noexcept
   {
      NASDAQ::ITCHTradingStateMessage *m = nullptr;
      parser.itch_pools_.get_pool<NASDAQ::ITCHTradingStateMessage>().acquire(m);
