...
MessagePools<BIST::OUCHMessageTypes> Parser_OUCH_BIST::ouch_pools_;
...
const std::array<Parser_OUCH_BIST::MessageHandlerFunc, Parser_OUCH_BIST::MAX_MESSAGES>& Parser_OUCH_BIST::makeMessageHandlersLookup() noexcept
{
   ...
   handlers[0] = [](const char *data, BIST::OUCHMessage &msg) noexcept
   {
      ...
      ouch_pools_.get_pool<BIST::OUT::OUCHOrderAcceptedMessage>().acquire(m);
   ...
   handlers[1] = [](const char *data, BIST::OUCHMessage &msg) noexcept
   {
      BIST::OUT::OUCHOrderRejectedMessage *m = nullptr;
      ouch_pools_.get_pool<BIST::OUT::OUCHOrderRejectedMessage>().acquire(m);
   ...
   handlers[2] = [](const char *data, BIST::OUCHMessage &msg) noexcept
   {
      BIST::OUT::OUCHOrderReplacedMessage *m = nullptr;
      ouch_pools_.get_pool<BIST::OUT::OUCHOrderReplacedMessage>().acquire(m);
   ...
   handlers[3] = [](const char *data, BIST::OUCHMessage &msg) noexcept
   {
      BIST::OUT::OUCHOrderCancelledMessage *m = nullptr;
      ouch_pools_.get_pool<BIST::OUT::OUCHOrderCancelledMessage>().acquire(m);
   ...
   handlers[4] = [](const char *data, BIST::OUCHMessage &msg) noexcept
   {
      BIST::OUT::OUCHOrderExecutedMessage *m = nullptr;
      ouch_pools_.get_pool<BIST::OUT::OUCHOrderExecutedMessage>().acquire(m);
