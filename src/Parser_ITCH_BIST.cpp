...
MessagePools<BIST::ITCHMessageTypes> Parser_ITCH_BIST::itch_pools_;
...
const std::array<Parser_ITCH_BIST::MessageHandlerFunc, Parser_ITCH_BIST::MAX_MESSAGES>& Parser_ITCH_BIST::makeMessageHandlersLookup() noexcept
{
   ...
   handlers[0] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      ...
      itch_pools_.get_pool<BIST::ITCHSecondsMessage>().acquire(m);
   ...
   handlers[1] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHOrderBookDirectoryMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHOrderBookDirectoryMessage>().acquire(m);
   ...
   handlers[2] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHCombinationOrderBookLegMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHCombinationOrderBookLegMessage>().acquire(m);
   ...
   handlers[3] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHTickSizeTableEntryMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHTickSizeTableEntryMessage>().acquire(m);
   ...
   handlers[4] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHShortSellStatusMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHShortSellStatusMessage>().acquire(m);
   ...
   handlers[5] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHSystemEventMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHSystemEventMessage>().acquire(m);
   ...
   handlers[6] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHOrderBookStateMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHOrderBookStateMessage>().acquire(m);
   ...
   handlers[7] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHAddOrderMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHAddOrderMessage>().acquire(m);
   ...
   handlers[8] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHOrderExecutedMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHOrderExecutedMessage>().acquire(m);
   ...
   handlers[9] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHOrderExecutedWithPriceMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHOrderExecutedWithPriceMessage>().acquire(m);
   ...
   handlers[10] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHOrderDeleteMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHOrderDeleteMessage>().acquire(m);
   ...
   handlers[11] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHOrderBookFlushMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHOrderBookFlushMessage>().acquire(m);
   ...
   handlers[12] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHTradeMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHTradeMessage>().acquire(m);
   ...
   handlers[13] = [](const char *data, BIST::ITCHMessage &msg) noexcept
   {
      BIST::ITCHEquilibriumPriceUpdateMessage *m = nullptr;
      itch_pools_.get_pool<BIST::ITCHEquilibriumPriceUpdateMessage>().acquire(m);
