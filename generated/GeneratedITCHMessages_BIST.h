...
struct ITCHCombinationOrderBookLegMessage {
    uint32_t timestamp_ns = 0;                     // Nanoseconds part | offset: 1, len: 4
...
struct ITCHShortSellStatusMessage {
    uint32_t timestamp_ns = 0;                 // Nanoseconds part | offset: 1, len: 4
...
struct ITCHOrderBookStateMessage {
    uint32_t timestamp_ns = 0;         // Nanoseconds part | offset: 1, len: 4
    uint32_t order_book_id = 0;        // Order book ID | offset: 5, len: 4
...
struct ITCHOrderBookFlushMessage {
    uint32_t timestamp_ns = 0;         // Nanoseconds part | offset: 1, len: 4
    uint32_t order_book_id = 0;        // Order book ID | offset: 5, len: 4
