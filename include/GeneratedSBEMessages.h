...
inline constexpr SBETypes MessageIndex(uint16_t templateId) {
   ...
   switch(templateId) {
      case 0: return SBETypes::SBEADDORDERMESSAGE; 
      case 1: return SBETypes::SBEDELETEORDERMESSAGE; 
      case 2: return SBETypes::SBETRADEMESSAGE; 
      case 3: return SBETypes::SBEMODIFYORDERMESSAGE; 
      case 4: return SBETypes::SBEHEARTBEATMESSAGE; 
