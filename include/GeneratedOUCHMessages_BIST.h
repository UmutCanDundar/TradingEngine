...
struct alignas(64) OUCHCancelByOrderIDMessage {
...
struct alignas(64) OUCHOrderExecutedMessage {
    ...
    char pad1[12];                       // Padding
    char reserved[16] = {};              // Reserved | offset: 52, len: 16
    char pad2[48];                       // Padding
};

}

enum class OUCHTypes : uint8_t {   O = 0,  u = 1,  X = 2,  Y = 3,  A = 4,  J = 5,  U = 6,  C = 7,  E = 8,  unknownOUCHtype = 99 };
