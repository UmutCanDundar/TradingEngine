...
struct alignas(64) OUCHEnterOrderMessage {
    ...
    char optional_appendage[0] = {};                 // Optional fields (Firm, MinQty, CustomerType, MaxFloor, PriceType, PegOffset, etc.) | offset: 47, len: variable
    char pad[17];                                    // Padding
};
...
struct alignas(64) OUCHReplaceOrderMessage {
    ...
    char optional_appendage[0] = {};                 // Optional fields (MinQty, MaxFloor, PriceType, PostOnly, ExpireTime, TradeNow, HandleInst, etc.) | offset: 40, len: variable
    char pad[24];                                    // Padding
};
...
struct alignas(64) OUCHCancelOrderMessage {
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 11, len: variable
    char pad[53];                           // Padding
};

struct alignas(64) OUCHModifyOrderMessage {
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx, SharesLocated, LocateBroker) | offset: 12, len: variable
    char pad[52];                           // Padding
};

struct alignas(64) OUCHAccountQueryRequest {
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 3, len: variable
    char pad[61];                           // Padding
};
...
struct alignas(64) OUCHSystemEventMessage {
...
struct alignas(64) OUCHOrderAcceptedMessage {
    uint64_t timestamp = 0;                           // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};                  // Optional fields (Firm, MinQty, CustomerType, MaxFloor, PriceType, etc.) | offset: 64, len: variable
};

struct alignas(64) OUCHOrderReplacedMessage {
    uint64_t timestamp = 0;                           // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};                  // Optional fields (Firm, MinQty, MaxFloor, PriceType, etc.) | offset: 68, len: variable
    char pad[60];                                     // Padding
};

struct alignas(64) OUCHOrderCancelledMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 20, len: variable
    char pad[44];                           // Padding
};

struct alignas(64) OUCHOrderExecutedMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 36, len: variable
    char pad[28];                           // Padding
};

struct alignas(64) OUCHOrderRejectedMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 31, len: variable
    char pad[33];                           // Padding
};

struct alignas(64) OUCHBrokenTradeMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 38, len: variable
    char pad[26];                           // Padding
};

struct alignas(64) OUCHOrderModifiedMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx, SharesLocated, LocateBroker) | offset: 20, len: variable
    char pad[44];                           // Padding
};

struct alignas(64) OUCHCancelPendingMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    uint32_t user_ref_num = 0;              // Order UserRefNum | offset: 9, len: 4
    ...
    char optional_appendage[0] = {};        // Optional fields (UserRefIdx) | offset: 15, len: variable
    char pad[49];                           // Padding
};

struct alignas(64) OUCHCancelRejectMessage {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
    uint32_t user_ref_num = 0;              // Order UserRefNum | offset: 9, len: 4
    uint16_t appendage_length = 0;          // Length of optional appendage | offset: 13, len: 2
...
struct alignas(64) OUCHAccountQueryResponse {
    uint64_t timestamp = 0;                 // Nanoseconds since midnight | offset: 1, len: 8
...
enum class OUCHTypes : uint8_t {   O = 0,  u = 1,  X = 2,  m = 3,  q = 4,  S = 5,  A = 6,  U = 7,  C = 8,  E = 9,  J = 10,  B = 11,  M = 12,  P = 13,  I = 14,  Q = 15,  unknownOUCHtype = 99 };

inline constexpr OUCHTypes ouchMessageIndex(char type) {

   switch(type) {
      case 'O': return OUCHTypes::O;
      case 'u': return OUCHTypes::u;
      case 'X': return OUCHTypes::X;
