...
BENCHMARK_DEFINE_F(BM_OrderManager, OuchBist)(benchmark::State& state)
{
    pin_to_cpu(2);
...
BENCHMARK_REGISTER_F(BM_OrderManager, OuchBist)->UseManualTime();
